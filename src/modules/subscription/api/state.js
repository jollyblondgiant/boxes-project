...
import {
  ...
  SUBSCRIPTIONS_GET_LIST_BY_USER_RESPONSE,
    ...
    SUBSCRIPTIONS_GET_LIST_BY_CRATE_REQUEST,
    SUBSCRIPTIONS_GET_LIST_BY_CRATE_RESPONSE,
    SUBSCRIPTIONS_GET_LIST_BY_CRATE_FAILURE,
...
// Subscriptions list by crate

// Initial State
const subscriptionsByCrateInitialState = {
    isLoading: false,
    error: null,
    //list: [],
    //average: 1
...
// State
export const subscriptionsByCrate = (state = subscriptionsByCrateInitialState, action) => {
    switch (action.type) {
    case SUBSCRIPTIONS_GET_LIST_BY_CRATE_REQUEST:
        return {
            ...state,
            isLoading: action.isLoading,
            error: null
    ...
    case SUBSCRIPTIONS_GET_LIST_BY_CRATE_RESPONSE:
    ...
    case SUBSCRIPTIONS_GET_LIST_BY_CRATE_FAILURE:
        return {
            ...state,
            isLoading: false,
            error: action.error
